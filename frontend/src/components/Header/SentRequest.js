...
export default function SentRequest(props) {
    ...
    const deleteFriendRequest = async() => {
        ...
        try{
            await axios.delete(((process.env.NODE_ENV==="development") ? "http://localhost:8001/" : "http://motion-t3.propulsion-learn.ch/") + `backend/api/social/friends/requests/${props.id}/`,config)
        }
