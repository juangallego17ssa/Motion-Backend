    ...
    const getUser = async () => {
      setIsLoading(true)
        try {
            ...
            const response = await axios.get(((process.env.NODE_ENV==="development") ? "http://localhost:8001/" : "http://motion-t3.propulsion-learn.ch/") + `backend/api/users/?limit=50`, config);
